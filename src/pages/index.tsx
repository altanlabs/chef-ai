...
const HomePage = () => {
  ...
  return (
    <Layout showSidebar={false} showHeader={true} showFooter={true} sidebarConfig={{ items: [] }} header={undefined} footer={undefined}>
      <div className="flex flex-col items-center justify-center min-h-screen bg-background text-foreground">
        ...
        <main className="flex flex-col items-center mt-8">
          ...
          <Select value={expertise} onValueChange={(value: string) => setExpertise(value)} className="mb-4">
